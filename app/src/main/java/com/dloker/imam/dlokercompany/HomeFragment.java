...
//                                Log.d("TAG", h.getImgSrc());
    ...
    public void retrieveUsers(){
        ...
        //db = FirebaseDatabase.getInstance();
        DatabaseReference mdata = db.getReference().child("Users");
        mdata.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                for (DataSnapshot ds : dataSnapshot.getChildren()){
                    //Log.d("coba", ds.getKey());
                    usr.put(ds.getKey(), ds.child("Nama").getValue(String.class));
                    usr.put(ds.getKey()+"pict", ds.child("Pict").getValue(String.class));
                }
            }
