...
public class DitolakFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.fragment_ditolak, container, false);
        db = FirebaseDatabase.getInstance();
        mAuth = FirebaseAuth.getInstance();
        recyclerView = (RecyclerView) v.findViewById(R.id.recV_refused);
            ...
            public void onDataChange(final DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()){
                    if (snapshot.child("idCompany").exists()) {
                        if (snapshot.child("idCompany").getValue().equals(myUid) && snapshot.child("statusLmr").getValue().equals("refused")) {
                ...
                adapter = new myAdapter(listItems, getActivity(), new myAdapter.OnItemClicked() {
                    ...
                    public void onItemClick(int position) {
                        ...
                        intent.putExtra("status", "Telah Ditolak");
